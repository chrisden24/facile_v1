...
<head>
    ...
    <?php include("header.php"); ?>
        ...
        <section class="page-header">
            ...
            <div class="container">
                <div class="page-header__inner">
                    <h3>Facile Auto Register Generation</h3>
        ...
        <section class="cus-indu-one">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6 order-lg-2">
                        <div class="cus-indu-img">
                            <img src="assets/images/resources/about-one-img-2.jpg" class="" alt="">
                        </div>
                    </div>
                    <div class="col-lg-6 order-lg-1">
                        <div class="about-one__left">
                            <div class="section-title text-left sec-title-animation animation-style2">
                                <h2 class="section-title__title title-animation">Title<span> Here</span></h2>
                            </div>
                            <p class="about-one__text">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                        </div>
                    </div>
                </div>
            </div>
...
<!--         <section class="cus-indu-one cus-indu-bg">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6 order-lg-1">
                        <div class="cus-indu-img">
        ...
        <section class="cus-indu-one pt-0">
            <div class="container">
                            ...
                            <div class="service-details__img-box-single">
                                ...
                                <div class="service-details__img-box-content">
                                    <div class="service-details__img-box-content-icon-and-title">
                                        ...
                                        <h3 class="service-details__img-box-content-title">Title Here
                                        </h3>
                                    </div>
                            ...
                            <div class="service-details__img-box-single">
                                ...
                                <div class="service-details__img-box-content">
                                    <div class="service-details__img-box-content-icon-and-title">
                                        ...
                                        <h3 class="service-details__img-box-content-title">Title Here</h3>
                                    </div>
                                    <p class="service-details__img-box-content-text">Duis acute arura dolor
                                        in
                                        reprehenderit in voluptate velit esse cillum dolore Velit esse quam
        ...
        <section class="cus-indu-one cus-indu-bg">
            <div class="container">
                <div class="row mt-5">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6 wow fadeInLeft" data-wow-delay="100ms">
                        <div class="process-one__single-inner">
                            <div class="process-one__single">
                                ...
                                <h3 class="process-one__title">Title Here</h3>
                                <p class="process-one__text">Once the strategy is in place, we move to
                                    designing and developing your vision.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <!--Process One Single End-->
                    <!--Process One Single Start-->
                    <div class="col-xl-3 col-lg-3 col-md-6 wow fadeInRight" data-wow-delay="300ms">
                        <div class="process-one__single-inner">
                            <div class="process-one__single">
                                <div class="process-one__icon">
                    ...
                    <!--Process One Single End-->
                    <!--Process One Single Start-->
                    <div class="col-xl-3 col-lg-3 col-md-6 wow fadeInRight" data-wow-delay="400ms">
                        <div class="process-one__single-inner">
                            <div class="process-one__single">
                                <div class="process-one__icon">
